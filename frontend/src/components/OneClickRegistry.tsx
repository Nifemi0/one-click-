...
export default function OneClickRegistry() {
  ...
  const fetchRegistryData = async () => {
    try {
      ...
      const statsResponse = await fetch(`${API_BASE}/api/oneclick-registry/stats`);
      if (statsResponse.ok) {
      ...
      const trapsResponse = await fetch(`${API_BASE}/api/oneclick-registry/traps?page=0&pageSize=20`);
      if (trapsResponse.ok) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-4">
            ...
            <h1 className="text-3xl font-bold text-white mb-8">One Click Registry</h1>
          </div>
