...
const navigation = {
  ...
  social: [
    {
      name: 'Twitter',
      href: 'https://twitter.com/drosera',
      icon: (props: any) => (
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-300">
              Democratizing access to DeFi security through intelligent, one-click deployment of security traps.
            </p>
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-gray-400">
            &copy; {new Date().getFullYear()} Drosera Network. All rights reserved. Built with ❤️ for the DeFi community.
          </p>
        </div>
      </div>
    </footer>
